...
export default function Login() {
    ...
    const register = (usn) => {
        ...
        } else { setStatement('Username cannot contain special characters.')}
    }
            ...
            <form>
                ...
                <div class="row mb-2">
                    ...
                    {admin && (
                        <div class="row">
                            <div class="col-auto">
                                <a href="/admin" class="btn btn-secondary btn-lg">Continue</a> 
                            </div>
                            <div class="col-auto">
                                <button class="btn btn-secondary btn-lg" onClick={()=> cancel()}>Cancel</button>
                            </div>
